...
- (void)viewDidLoad {
    ...
    NSString *strAboutUs = [NSString stringWithFormat:@"<h2 style='font-size:22px;font-weight:800;border-bottom:1px solid color:rgb(238,121,0);color:rgb(238,121,0);'>Contact Us</h2><p style='font-size:16px;color:rgb(255,255,255);'>The Morning Kitchen<br/>004, Satva Complex,<br/>B/H Govardhan Party Plot,<br/>Thaltej, Ahmedabad - 380 059</p><p style='font-size:16px;color:rgb(255,255,255);'>Pushparajsinh - +91 7575 0020 75</p><p style='font-size:16px;color:rgb(255,255,255);'>Hitesh Rathi - +91 7575 0020 00</p><p style='font-size:16px;color:rgb(255,255,255);'>Devang Patel - +91 8488 880186</p>"];
    ...
    txtContactUs.attributedText=attributedString;
    
    CGFloat fixedWidth = txtContactUs.frame.size.width;
    CGSize newSize = [txtContactUs sizeThatFits:CGSizeMake(fixedWidth, MAXFLOAT)];
    CGRect newFrame = txtContactUs.frame;
    newFrame.size = CGSizeMake(fmaxf(newSize.width, fixedWidth), newSize.height);
    txtContactUs.frame = newFrame;
    
    scrollView.contentSize = CGSizeMake(scrollView.frame.size.width, txtContactUs.frame.size.height+10);
}
